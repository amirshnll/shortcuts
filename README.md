...
| کلید | کارکرد |
| --- | --------------------------------------------------  |
| `/RENAME↵` |  تغییر نام کانال یا گروه |
| `/WHO↵` |  لیست کاربران در گروه و کانال جاری |
| `/SHORTCUTS↵` |  بازکردن پنجره کلیدهای میانبر |
| `/FEEDBACK↵` |  ارسال فیدبک به اسلک |
| `/OPEN↵` |  بازکردن کانال و گروه |
| `/MSG↵` |  ارسال پیام در دایرکت به کاربر دیگری |
| `ctrl+U` |  آپلود فایل |
| `shift+↵` |  ایجاد پیام جدید |
| `UP` |  ویرایش آخرین پیام در کانال فعلی |
| `shift+ESC` |  برچسب زدن همه پیام ها به عنوان خواندن شده |
| `ESC` |  برچسب زدن همه پیام ها به عنوان خواندن نشده |
| `ctrl+K` |  بازکردن پنجره سوییچ کردن سریع |
...
| کلید | کارکرد |
| --- | --------------------------------------------------  |
| `RIGHT` |  انتقال کارت به سمت راست |
| `LEFT` |  انتقال کارت به سمت چپ |
| `J` |  انتقال کارت به پایین |
| `K` |  انتقال کارت به بالا |
| `N` |  ایجاد کارت جدید |
| `[SPACE]` |  تعیین کردن من به عنوان مالک کارت |
| `C` |  آرشیو کردن کارت |
| `T` |  تغییر عنوان |
| `X` |  حذف همه فیلترها |
| `1` |  برچسب سبز |
